...
@end
static NSString *HelpCenterCellID = @"HelpCenterCellID";
...
- (void)requestData{
    ...
    paramesDic[@"p"] = @(p);
    [[RequestInstance shareInstance] POST:GETAPIURL(@"api/Help/List") parameters:paramesDic usableStatus:^(NSDictionary *dic) {
        if (_hud) {
...
- (void)resetData:(NSDictionary *)dict{
    ...
    for (NSDictionary *tempDic in dict) {
        HelpCenterModel *model = [[HelpCenterModel alloc] initWithDictionary:tempDic error:nil];
...
- (UITableView *)tableView{
    if (!_tableView) {
        ...
        [_tableView registerNib:[UINib nibWithNibName:@"HelpCenterCell" bundle:nil] forCellReuseIdentifier:HelpCenterCellID];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    HelpCenterCell *cell = [tableView dequeueReusableCellWithIdentifier:HelpCenterCellID forIndexPath:indexPath];
